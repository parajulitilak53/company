            ...
            <div class="card-body">
              ...
              <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="tel" name="phone" class="form-control" value="<?php echo $data['phone']; ?>" id="inputPhone">
                </div>
                <div class="col-md-6">
                  <label for="inputEmail4" class="form-label">Email</label>
                  <input type="email" name="email" class="form-control" value="<?php echo $data['email']; ?>" id="inputEmail4">
                </div>
