            ...
            <div class="card-body">
                    ...
                    if ($filesize <= 5000000) {
                      if ($ext == 'jpg' || $ext == 'png' | $ext == 'jpeg') {
                        if(move_uploaded_file($_FILES['dataFile']['tmp_name'],'../uploads/'.$finalname)){
                          $query= "INSERT INTO sliders (img,title,description) Values('$finalname', '$title', '$description')";
              ...
              <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-start">
                  <button type="submit" name="saveslider" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
          </div>
