            ...
            <div class="card-body">
              ...
              <?php
                    if (isset($_POST['savesetting'])) {
                        ...
                        if ($site_key != "" && $site_value != "") {
                            $insert = "INSERT INTO settings (site_key, site_value) VALUES('$site_key', '$site_value')";
              ...
              <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="site_value" class="form-control" id="inputValue">
                </div>
                <div class="text-start">
                  <button type="submit" name="savesetting" class="btn btn-primary">Submit</button> 
                </div>
              </form>
            </div>
          </div>
