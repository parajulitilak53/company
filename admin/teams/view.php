          ...
          <div class="card">
            ...
            ?>
              ...
              <div class="col-md-6">
                  ...
                  <input type="text" name="top_title" class="form-control" readonly value="<?php echo $data['top_title']  ?>" id="inputNanme4">
                </div>
                <div class="col-md-6">
                  <label for="inputNanme4" class="form-label">Top Description</label>
                  <input type="text" name="top_description" class="form-control" readonly value="<?php echo $data['top_description']  ?>" id="inputNanme4">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="position" class="form-control" readonly value="<?php echo $data['position']  ?>" id="inputNanme4">
                </div>
                <div class="col-md-6 overflow-hidden">
                  <img src="<?php echo "../uploads/" . $data['img'] ?>" alt="" srcset="" width="150px" height="140px">
                  <label for="inputPhone" class="form-label"><?php echo $data['img']  ?></label>
