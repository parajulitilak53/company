        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
                Manage Teams
                <a href="create.php" class="btn btn-primary float-end">Add Teams</a>
              </h5>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Top Description</th>
                ...
                <?php
                  ...
                  <tr>
                    ...
                    <td><?php echo $data['top_description']; ?></td>
                    <td><?php echo $data['name']; ?></td>
                    <td><?php echo $data['position']; ?></td>
                    <td> <img src="<?php echo  '../uploads/'.$data['img'];?>" class="img-fluid" alt="..." width="100" height="100"> </td>
                    <td>
