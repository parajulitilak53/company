    ...
    <section class="section">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update Feature
            ...
            if (isset($_POST['updatefeature'])) {
                ...
                if ($title != "" && $file == "") {
                    $querry = "UPDATE  features  SET  title='$title' WHERE id=$id";
                    ...
                    if ($file_size <= 500040) {
                        ...
                        if ($extlink == 'jpg' || $extlink == 'png' || $extlink == 'jpeg') {
                            ...
                            if (move_uploaded_file($_FILES['dataFile']['tmp_name'], $targrt_file)) {
                                ...
                                $querry = "UPDATE  features  SET icon='$finalname',  title='$title' WHERE id=$id";
                                $result = mysqli_query($con, $querry);
                                if ($result) {
                                    echo "File uploaded";
            ...
            ?>
               <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-start">
                  <button type="submit" name="updatefeature" class="btn btn-primary">Update</button>
                </div>
              </form>
            </div>
          </div>
