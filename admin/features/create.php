    ...
    <section class="section">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Feature
                    ...
                    if ($filesize <= 5000000) {
                      if ($ext == 'jpg' || $ext == 'png' | $ext == 'jpeg') {
                        if(move_uploaded_file($_FILES['dataFile']['tmp_name'],'../uploads/'.$finalname)){
                          $query= "INSERT INTO features (icon,title) Values( '$finalname', '$title')";
              ...
              <form class="row g-3" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-start">
                  <button type="submit" name="savefeature" class="btn btn-primary">Submit</button>
                </div>
              </form>
            </div>
          </div>
